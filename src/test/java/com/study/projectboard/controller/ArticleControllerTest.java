...
class ArticleControllerTest {
    ...
    @Test
    public void givenNothing_whenRequestingArticleSearchHashtagView_thenReturnsArticleSearcHashtaghView() throws Exception {
        // Given
    ...
    @WithUserDetails(value = "minsTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
    ...
    @Test
    void givenNothing_whenRequesting_thenReturnsUpdatedArticlePageToLogin() throws Exception {
        // Given
        long articleId = 1L;
